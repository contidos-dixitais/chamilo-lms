...
/**
 * Class SmowlNamesRoleProvisioningService.
 */
class SmowlNamesRoleProvisioningService extends SmowlAdvantageService
{
    ...
    public static function getResource(Request $request, JsonResponse $response) {
        ...
        if (isset($parts[1], $parts[2]) &&
            ...
            $resource = new SmowlContextMembershipResource(
    ...
    {
        $base = api_get_path(WEB_PLUGIN_PATH).'smowl/nrps2.php';
        $resource = str_replace(
            'context_id',
            $courseId,
            SmowlContextMembershipResource::URL_TEMPLATE
        );
