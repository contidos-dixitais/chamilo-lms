...
/**
 * Class SmowlLineItemResource.
 */
class SmowlLineItemResource extends SmowlAdvantageServiceResource
{
    ...
    /**
     * SmowlLineItemResource constructor.
     *
     * @param int $toolId
     * @param int $courseId
    ...
    public function validate()
    {
        ...
        if ($this->request->server->get('HTTP_ACCEPT') !== SmowlAssignmentGradesService::TYPE_LINE_ITEM) {
