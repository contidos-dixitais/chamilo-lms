...
/**
 * Class SmowlScoresResource.
 */
class SmowlScoresResource extends SmowlAdvantageServiceResource
{
    ...
    /**
     * SmowlScoresResource constructor.
     *
     * @param int $toolId
     * @param int $courseId
    ...
    public function validate()
    {
        ...
        if ($this->request->server->get('HTTP_ACCEPT') !== SmowlAssignmentGradesService::TYPE_SCORE) {
    ...
    public function process()
    {
        switch ($this->request->getMethod()) {
            case Request::METHOD_POST:
                $this->validateToken(
                    [SmowlAssignmentGradesService::SCOPE_SCORE_WRITE]
                );
                $this->processPost();
                break;
            default:
    ...
    private function processPost()
    {
        ...
        if (empty($data) ||
            ...
            (isset($data['timestamp']) && !Smowl::validateFormatDateIso8601($data['timestamp'])) ||
