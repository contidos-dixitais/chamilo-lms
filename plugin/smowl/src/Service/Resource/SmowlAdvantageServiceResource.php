...
use Chamilo\PluginBundle\Entity\Smowl\Token;
...
/**
 * Class SmowlAdvantageServiceResource.
 */
abstract class SmowlAdvantageServiceResource
{
    const URL_TEMPLATE = '/';
    ...
    /**
     * SmowlAdvantageServiceResource constructor.
     *
     * @param int $toolId
     * @param int $courseId
     *
    ...
    public function __construct($toolId, $courseId)
    {
        ...
        $this->tool = Database::getManager()->find('ChamiloPluginBundle:Smowl\SmowlTool', (int) $toolId);
    }
    ...
    protected function validateToken(array $allowedScopes)
    {
        ...
        $token = Database::getManager()
            ->getRepository('ChamiloPluginBundle:Smowl\Token')
            ->findOneBy(['hash' => $hash]);
