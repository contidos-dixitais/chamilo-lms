...
/**
 * Class SmowlContentItem.
 */
class SmowlResourceLink extends SmowlContentItemType
{
    /**
     * @var string
     */
    ...
    /**
     * @param SmowlTool $baseTool
     *
     * @return SmowlTool
     */
    private function createTool(SmowlTool $baseTool)
    {
     ...
     * @return SmowlTool
     */
    public function save(SmowlTool $baseTool, Course $course)
    {
        ...
        SmowlPlugin::create()->addCourseTool($course, $newTool);
    }
}
