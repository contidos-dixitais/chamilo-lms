...
class Smowl
{
    ...
    public static function getSubstitutableVariables(
        ...
        $isSmowl1p3 = $ltiVersion === self::V_1P3;

        return [
            '$User.id' => $user->getId(),
            '$User.image' => $isSmowl1p3 ? ['claim' => 'sub'] : ['user_image'],
            '$User.username' => $user->getUsername(),
            '$User.org' => false,
            '$User.scope.mentor' => $isSmowl1p3 ? ['claim' => '/claim/role_scope_mentor'] : ['role_scope_mentor'],

            '$Person.sourcedId' => $isSmowl1p3
                ? self::getPersonSourcedId($domain, $user)
                : "$domain:".SmowlPlugin::getLaunchUserIdClaim($tool, $user),
            ...
            '$CourseSection.sourcedId' => $isSmowl1p3
            ...
            '$Membership.role' => $isSmowl1p3 ? ['claim' => '/claim/roles'] : ['roles'],

            '$Result.sourcedGUID' => $isSmowl1p3 ? ['claim' => 'sub'] : ['lis_result_sourcedid'],
            '$Result.sourcedId' => $isSmowl1p3 ? ['claim' => 'sub'] : ['lis_result_sourcedid'],

            '$ResourceLink.id' => $isSmowl1p3
                ? ['claim' => '/claim/resource_link', 'property' => 'id']
                : ['resource_link_id'],
            '$ResourceLink.title' => $isSmowl1p3
                ? ['claim' => '/claim/resource_link', 'property' => 'title']
                : ['resource_link_title'],
            '$ResourceLink.description' => $isSmowl1p3
     ...
     * @return array
     */
    public static function getAdvantageServices(SmowlTool $tool)
    {
        return [
            new SmowlAssignmentGradesService($tool),
            new SmowlNamesRoleProvisioningService($tool),
        ];
    }
