...
// Allow delete question of of a exercise when deleting it.
// Only delete questions when them are not originaly from other exercises (reused questions).
// If the exercise has questions reused on another tests, the question will be deleted from all tests.
//$_configuration['exercise_remove_delete_questions'] = false;
